...
const simulatedResponses = [
  "Merci pour votre retour. Nous prenons en compte vos remarques et travaillons activement à améliorer notre service. N'hésitez pas à nous contacter directement pour toute question.",
  "Nous comprenons votre frustration et nous en sommes sincèrement désolés. Notre équipe a été informée et prend les mesures nécessaires pour résoudre ce problème rapidement.",
  "Bonjour ! Nous apprécions votre fidélité et votre commentaire positif. C'est grâce à des clients comme vous que nous continuons à innover chaque jour.",
];
...
export default function AIAssistant() {
  ...
  const [history, setHistory] = useState(aiResponses);
