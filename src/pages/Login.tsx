            ...
            <div className="grid grid-cols-2 gap-2">
              <Button type="button" variant="outline" className="rounded-xl" onClick={async () => {
                try {
                  ...
                  if (r.error) toast.error("Google: " + ((r.error as any)?.message ?? "connexion impossible"));
                } catch (e: any) {
                  toast.error("Google: " + (e?.message ?? "erreur réseau"));
                }
              }}>
              ...
              <Button type="button" variant="outline" className="rounded-xl" onClick={async () => {
                try {
                  ...
                  if (r.error) toast.error("Apple: " + ((r.error as any)?.message ?? "connexion impossible"));
                } catch (e: any) {
                  toast.error("Apple: " + (e?.message ?? "erreur réseau"));
                }
              }}>
